...
Upsert for the prefix GPLAIN_FIN1. Does not upsert where Account is 'GPLNLN%'.
...
and target.fileDt = (select top 1 fileDt from #finance)
and target.Account not like 'GPLNLN%'	-- only for fin1
